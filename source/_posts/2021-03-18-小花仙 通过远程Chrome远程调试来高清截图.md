...
参考之前的文章[python selenium chrome 控制devtools 一些线索](https://blog.csdn.net/qq_35977139/article/details/111399633)将一个可以使用Flash的浏览器添加一个启动参数```--remote-debugging-port=9222```，然后访问```http://hua.61.com/Client.swf```，登录账号，然后打开要截图的玩家面板。
